...
const formSchema = z.object({
    content: z
    .string()
    .min(1, "Project descriptn is required")
...
const PROJECT_TEMPLATES = [
    {
        ...
        prompt: 
            'Build a Netflix-style homepage with a hero banner (use a nice, dark-mode compatible gradient here), movie sections, responsive cards & a model for viewing details using mock data and local state. Use dark mode.'
    },
    {
        emoji: '📦',
        title: 'Build an admin dashboard',
        prompt: 
            'Create an admin dashboard with a sidebar, stat cards, a chat placeholder & a basic table with filter and pagination using local state. Use clear visual grouping and balance in your design for a modern, professional look'
    },
    {
        emoji: '🎨',
    ...
    },
    {
        ...
        prompt: 
            'Build a storage page with category filters, a product grid and local cart logic to add and remove items. Focus on clear typography, spacing and button states for a great e-commerce UI.'
    },
    {
        emoji: '🏡',
        title: 'Build an Airbnb clone',
        prompt: 
            'Build an Airbnb-style listings grid with mock data, filter sidebar and a modal property details using local state. Use card spacing, soft shadows and clean layout for a welcoming design.'
    },
    {
        emoji: '🎵',
        title: 'Build a Spotify clone',
        prompt: 
            'Build a Spotify-style music player with a siderbar for playlists, a main area for song details and playback controls. Use local state for managing playback and song selection. Prioritize layout balance and intuitive control placement for a smooth user experience. Use dark mode.'
    }
]
